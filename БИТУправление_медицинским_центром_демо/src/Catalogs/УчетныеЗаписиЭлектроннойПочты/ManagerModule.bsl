...
// Функция РазрешенияУчетныхЗаписей.
//
// Параметры:
//  УчетнаяЗапись	 - СправочникСсылка.УчетныеЗаписиЭлектроннойПочты	 - По умолчанию Неопределено
// 
// Возвращаемое значение:
//  Соответствие .
//
...
// Процедура ОпределитьНастройкиУчетнойЗаписи.
//
// Параметры:
...
// Функция ОпределитьНастройкиSMTP.
//
// Параметры:
//  АдресЭлектроннойПочты - Строка - почта.
//  Пароль - Строка - пароль.
//
// Возвращаемое значение:
//  Неопределено.
//
Функция ОпределитьНастройкиSMTP(АдресЭлектроннойПочты, Пароль) Экспорт
