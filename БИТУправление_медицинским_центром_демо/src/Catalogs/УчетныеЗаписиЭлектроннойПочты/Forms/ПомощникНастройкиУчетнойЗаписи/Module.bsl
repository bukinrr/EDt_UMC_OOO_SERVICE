...
Процедура СоздатьУчетнуюЗапись()
	...
	Если КонтекстныйРежим И ВидУчетнойЗаписи = "Общая" И Справочники.УчетныеЗаписиЭлектроннойПочты.СистемнаяУчетнаяЗаписьЭлектроннойПочты.АдресЭлектроннойПочты = "@" Тогда
