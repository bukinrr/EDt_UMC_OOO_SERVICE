...
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка - узел.
...
// Параметры:
//  НастройкаВыполненияОбмена - Стурктура.
//
// Возвращаемое значение:
//  РасписаниеРегламентногоЗадания.
//
...
//  ТекущийОбъект - ПланОбменаСсылка.
//
...
//  РегламентноеЗаданиеОбъект	 - РегламентноеЗадание	 - объект регламентного задания, которое необходимо записать.
//
...
// Процедура УдалитьВыгрузкуВСценарииОбменаДанными.
//
// Параметры:
...
// Процедура УдалитьЗагрузкуВСценарииОбменаДанными.
//
// Параметры:
//  СценарийОбменаДанными - Неопределено
//  УзелИнформационнойБазы - Неопределено
...
// Процедура ДобавитьВыгрузкуВСценарииОбменаДанными.
//
// Параметры:
//  СценарийОбменаДанными - Неопределено
//  УзелИнформационнойБазы - Неопределено
...
// Процедура ДобавитьЗагрузкуВСценарииОбменаДанными.
//
// Параметры:
//  СценарийОбменаДанными - Неопределено
//  УзелИнформационнойБазы - Неопределено
