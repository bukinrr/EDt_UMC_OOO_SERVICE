...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСФормамиСервер.УстановитьОтборФилиалВФормеСписка(ЭтаФорма,Метаданные.Справочники.Склады);
...
Процедура СохранитьНастройкиФормы()
	...
	РаботаСФормамиСервер.СохранитьИспользованиеОтбораФилиалВФорме(Метаданные.Справочники.Склады, ЗначениеЗаполнено(ОтборФилиал));
