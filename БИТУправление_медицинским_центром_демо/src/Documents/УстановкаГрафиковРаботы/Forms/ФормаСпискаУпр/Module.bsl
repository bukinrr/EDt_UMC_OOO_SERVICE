...
&НаКлиенте
Процедура ОткрытьФормуСобытий(Команда)
	
	СсылкаНаЭлемент = Элементы.Список.ТекущаяСтрока;
	ПараметрыФормы = Новый Структура("Ключ", СсылкаНаЭлемент);
	ОткрытьФорму("Документ.УстановкаГрафиковРаботы.Форма.ФормаДокументаСлужебная", ПараметрыФормы); 			
