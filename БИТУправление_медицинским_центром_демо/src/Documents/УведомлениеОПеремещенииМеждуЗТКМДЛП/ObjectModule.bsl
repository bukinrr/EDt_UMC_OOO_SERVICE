...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ПараметрыОперации.ЭтоПеремещениеМеждуЗТК              = Истина;
	ПараметрыОперации.ИсходнаяЗонаТаможенногоКонтроля     = ЗонаТаможенногоКонтроляОтгрузки;
	ПараметрыОперации.НоваяЗонаТаможенногоКонтроля        = ЗонаТаможенногоКонтроляПриемки;
