...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	МодульОбновлениеИБ = ОбщегоНазначения.ОбщийМодуль("ОбновлениеИнформационнойБазы");
	
	Выборка = МодульОбновлениеИБ.ВыбратьСсылкиДляОбработки(Параметры.Очередь, "Документ.Анкета");
	...
	Параметры.ОбработкаЗавершена = МодульОбновлениеИБ.ОбработкаДанныхЗавершена(Параметры.Очередь, "Документ.Анкета");
