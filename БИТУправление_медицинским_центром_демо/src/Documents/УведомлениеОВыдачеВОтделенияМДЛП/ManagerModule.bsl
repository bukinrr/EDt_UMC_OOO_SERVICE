...
Процедура ОбновитьСостояниеПодтверждения(ДокументОбъект, Операция, Сообщение, СтатусОбработки, ОтклоненныеНомера = Неопределено) Экспорт
	...
	Если Операция = Перечисления.ОперацииОбменаМДЛП.Получение_ВыдачаЛПДляОказанияМедицинскойПомощиСКЗКМ
	 Или Операция = Перечисления.ОперацииОбменаМДЛП.Получение_ВыдачаЛПСНевалиднымКМДляОказанияМедицинскойПомощиСКЗКМ Тогда
		...
		Если Операция = Перечисления.ОперацииОбменаМДЛП.Получение_ВыдачаЛПДляОказанияМедицинскойПомощиСКЗКМ Тогда
			ДанныеДокумента = ОбъектXDTO.skzkm_health_care;
		ИначеЕсли Операция = Перечисления.ОперацииОбменаМДЛП.Получение_ВыдачаЛПСНевалиднымКМДляОказанияМедицинскойПомощиСКЗКМ Тогда
			ДанныеДокумента = ОбъектXDTO.skzkm_code_error_healthcare;
		КонецЕсли;
	...
	ИначеЕсли Операция = Перечисления.ОперацииОбменаМДЛП.ПередачаДанных_ВыдачаЛПДляОказанияМедицинскойПомощиСКЗКМ Тогда
	...
	Иначе
		...
		ДанныеДокумента = ОбъектXDTO.health_care;
...
Функция ПоследовательностьОпераций(ДокументСсылка) Экспорт
	...
	Если ПередачаСведенийЧерезСКЗКМ = Истина Тогда
		...
		Операция = ИнтеграцияМДЛП.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящее, Перечисления.ОперацииОбменаМДЛП.Получение_ВыдачаЛПСНевалиднымКМДляОказанияМедицинскойПомощиСКЗКМ);
		Операция.КвитанцияПринят = Ложь;
	Иначе
...
Функция ПанельМаркировкиМДЛПТекстЗапросаДинамическогоСпискаКОформлению() Экспорт
	...
	ТекстЗапроса = ИнтеграцияМДЛППереопределяемый.УведомлениеОВыдачеВОтделенияТекстЗапросаДинамическогоСпискаКОформлению();
