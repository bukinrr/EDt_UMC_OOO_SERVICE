...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Документы.УведомлениеОВвозеЛПвРФМДЛП.ЗаполнитьИменаРеквизитовПоТипуОперации(Операция, ВсеРеквизиты, РеквизитыОперации);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	|ИЗ
	|	Документ.УведомлениеОВвозеЛПвРФМДЛП.НомераУпаковок КАК ПодтвержденныеУпаковки
	|ГДЕ
	...
	|ИЗ
	|	Документ.УведомлениеОВвозеЛПвРФМДЛП.ТранспортныеУпаковки КАК ПодтвержденныеУпаковки
	|ГДЕ
	|	ПодтвержденныеУпаковки.Ссылка = &Ссылка
	|	И ПодтвержденныеУпаковки.СостояниеПодтверждения = ЗНАЧЕНИЕ(Перечисление.СостоянияПодтвержденияМДЛП.Подтверждено)
	|;
	...
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		Документ.УведомлениеОВвозеЛПвРФМДЛП.СоставТранспортныхУпаковок КАК СоставТранспортныхУпаковок
	|	ПО
	...
	|	Документ.УведомлениеОВвозеЛПвРФМДЛП.ТранспортныеУпаковки КАК ТранспортныеУпаковки
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		Документ.УведомлениеОВвозеЛПвРФМДЛП.ИерархияГрупповыхУпаковок КАК НомераУпаковок
	|	ПО
	|		НомераУпаковок.Ссылка = ТранспортныеУпаковки.Ссылка
	...
	|		ИЗ
	|			Документ.УведомлениеОВвозеЛПвРФМДЛП.НомераУпаковок КАК Т
	|		ГДЕ
