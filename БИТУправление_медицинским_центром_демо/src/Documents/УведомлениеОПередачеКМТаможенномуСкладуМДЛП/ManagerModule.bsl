...
Функция ПоследовательностьОпераций(ДокументСсылка) Экспорт
	...
	Операция = ИнтеграцияМДЛП.ДобавитьОперациюВПоследовательность(Таблица, 0, Исходящее, Перечисления.ОперацииОбменаМДЛП.ПередачаДанных_ПередачаКМТаможенномуСкладу);
...
Функция ЗапросСтатусаОформления(ДокументОснование) Экспорт
	...
	Запрос = ИнтеграцияМДЛППереопределяемый.ЗапросСтатусаОформленияУведомленияОПередачеКМТаможенномуСкладу(ДокументОснование);
...
Процедура ПриЗаполненииДокументовПанелиМаркировкиМДЛП(ТаблицаДокументы) Экспорт
	...
	Описание = ИнтеграцияМДЛП.ДобавитьДокументНаПанельМаркировки(
		ТаблицаДокументы,
		Метаданные.Документы.УведомлениеОПередачеКМТаможенномуСкладуМДЛП,
		НСтр("ru = 'Передача КМ таможенному складу'"),
...
Функция ПанельМаркировкиМДЛПТекстЗапросаОформите() Экспорт
	...
	Возврат ИнтеграцияМДЛППереопределяемый.УведомлениеОПередачеКМТаможенномуСкладуТекстЗапросаОформите();
...
Функция ПанельМаркировкиМДЛПТекстЗапросаОтработайте() Экспорт
	...
	|		Документ.УведомлениеОПередачеКМТаможенномуСкладуМДЛП КАК Уведомления
	|	ПО
...
Функция ПанельМаркировкиМДЛПТекстЗапросаДинамическогоСпискаКОформлению() Экспорт
	...
	ТекстЗапроса = ИнтеграцияМДЛППереопределяемый.УведомлениеОПередачеКМТаможенномуСкладуТекстЗапросаДинамическогоСпискаКОформлению();
...
Функция СообщениеКПередаче(ДокументСсылка, ДальнейшееДействие, ДополнительныеПараметры = Неопределено) Экспорт
	...
	Возврат УведомлениеОПередачеКМТаможенномуСкладу(ДокументСсылка);
...
Функция ПредставлениеДокумента() Экспорт
	...
	ВозвращаемоеЗначение.КомандаСоздать                       = НСтр("ru = 'Создать уведомление о передаче КМ таможенному складу МДЛП'");
	ВозвращаемоеЗначение.ИмяКомандыСоздать                    = "СоздатьУведомлениеОПередачеКМТаможенномуСкладуМДЛП";
	ВозвращаемоеЗначение.ИмяКомандыОткрыть                    = "ОткрытьУведомлениеОПередачеКМТаможенномуСкладуМДЛП";
	ВозвращаемоеЗначение.ДокументОтсутствуетНетПравНаСоздание = НСтр("ru = 'Уведомление о передаче КМ таможенному складу МДЛП не создано'");
	ВозвращаемоеЗначение.Представление                        = НСтр("ru = 'Уведомление о передаче КМ таможенному складу МДЛП: %1'");
	ВозвращаемоеЗначение.НесколькоДокументовПредставление     = НСтр("ru = 'Уведомление о передаче КМ таможенному складу МДЛП (%1)'");
...
Функция УведомлениеОПередачеКМТаможенномуСкладу(ДокументСсылка)
	...
	СообщениеКПередаче.Операция = Перечисления.ОперацииОбменаМДЛП.ПередачаДанных_ПередачаКМТаможенномуСкладу;
	...
	|	Шапка.GTIN                                                           КАК GTIN
	|ИЗ
	|	Документ.УведомлениеОПередачеКМТаможенномуСкладуМДЛП КАК Шапка
	|ГДЕ
	|	Шапка.Ссылка = &Ссылка
	...
	|ИЗ
	|	Документ.УведомлениеОПередачеКМТаможенномуСкладуМДЛП.НомераУпаковок КАК НомераУпаковок
	|ГДЕ
	...
	ИмяТипа   = "documents";
	ИмяПакета = "transfer_code_to_custom";
