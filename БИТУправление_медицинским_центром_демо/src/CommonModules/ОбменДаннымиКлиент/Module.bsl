...
//
// Параметры:
//  Форма - ФормаКлиентскогоПриложения - управляемая форма, из которой вызвана процедура
//
...
//
// Параметры:
//  Отказ - Булево - флаг отказа от закрытия формы
//  Форма - ФормаКлиентскогоПриложения - управляемая форма, из которой вызвана процедура
//
...
//	НастройкаОбменаССервисом - Булево - По умолчанию Ложь.
//
...
//
// Параметры:
//  СсылкаНаПодробноеОписание - Неопределено
//
...
// 
// Параметры:
//  ОбрабатыватьПараметрыЗапуска - Булево - По умолчанию Ложь
//
...
//  ИмяСвойства			 - Строка		 - имя свойства объекта
//  СтандартнаяОбработка - Булево		 - флаг стандартной обработки.
//  Фильтр - Строка - По умолчанию ""
//  ПроверятьСуществованиеФайла - Булево - По умолчанию Истина
//
...
//  Знач ИмяРегистра - Строка
//  ФормаВладелец - Неопределено
//  Знач ИмяФормы - Строка - По умолчанию ""
//  ПараметрыФормы - Неопределено - По умолчанию Неопределено
//  ОткрытьМодально - Булево - По умолчанию Ложь
//
...
//  ДействиеПриОбменеСтрокой - Строка.
//
...
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка - узел плана обмена, для которого необходимо открыть форму;
//  Владелец               - ФормаКлиентскогоПриложения - форма-владелец для открываемой формы;
//
...
//
// Параметры:
//  ЗавершениеРаботыСистемы - Булево - По умолчанию Ложь
//
Процедура бспВыполнитьОбновлениеИнформационнойБазы(ЗавершениеРаботыСистемы = Ложь) Экспорт
...
// Обработчик вызывается при завершении работы помощника создания обмена данными по нажатию в помощнике на кнопку
//  "Готово".
//
// Параметры:
//  Помощник				 - ФормаКлиентскогоПриложения	 - Форма помощника создания обмена данными, которая является инициатором события.
//  ЗапуститьМенеджерЗаданий - Булево						 - Признак, показывающий, что необходимо выполнить запуск менеджера заданий (отдельного сеанса 1С:Предприятия)
...
//
// Параметры:
//  АдресДляВосстановленияПароляУчетнойЗаписи - Строка.
//
...
//  Владелец			 - Произвольный						 - владелец формы
//  Уникальность		 - Булево							 - параметр формы
//  Окно				 - ОкноКлиентскогоПриложения		 - параметр формы.
// 
// Возвращаемое значение:
//  ФормаКлиентскогоПриложения - Открытая форма
//
