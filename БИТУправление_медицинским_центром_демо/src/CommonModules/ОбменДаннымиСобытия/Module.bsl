...
#Область ПроцедурыИФункцииДлиИспользованияВОбработчикахСобытийПравилРегистрации

// Процедура дополняет список узлов-получателей объекта переданными значениями
//
// Параметры:
//  Объект	 - ДокументОбъект	 - объект, для которого выполняется правило регистрации
...
//
// Параметры:
//  Массив			 - Массив	 - источник
//  МассивВычитания	 - Массив	 - вычитаемое
// 
...
//
// Параметры:
//  ИмяПланаОбмена	 - Строка	 - имя плана обмена, список узлов для которого необходимо получить
// 
// Возвращаемое значение:
//  Массив.
//
...
//
// Параметры:
//  ОбъектМетаданных - ДокументОбъект	 - объект метаданных, для которого требуется получить признак авторегистрации
...
//
// Параметры:
//  Источник - ДокументОбъект	 - Произвольный объект
//  Отказ	 - Булево			 - Отмена операции.
//
...
// Параметры:
//  Источник		 - ДокументОбъект	 - Произвольный объект
//  ЭлементДанных	 - Произвольный		 - данные.
...
//
// Параметры:
//  Данные	 - Произвольный	 - набор данных произвольного регистра.
// 
// Возвращаемое значение:
//  Произвольный.
//
...
#Область МеханизмРегистрацииОбъектовМро
...
//
// Параметры:
//  Объект - СправочникОбъект, ДокументОбъект - Объект для получения значений реквизитов и др. свойств.
...
Процедура МеханизмРегистрацииОбъектов(ИмяПланаОбмена,
	...
	Если Не ОбменДаннымиПовтИсп.АвтоРегистрацияРазрешена(ИмяПланаОбмена, ОбъектМетаданных.ПолноеИмя()) Тогда
		...
		ОбменДаннымиПереопределяемый.ПослеОпределенияПолучателей(МассивУзловРезультат, Объект, ИмяПланаОбмена, ЭтоРегистр);
...
#Область ВыборочнаяРегистрацияОбъектовВро
...
#Область ПравилаРегистрацииОбъектовПро
...
//
// Параметры:
//  Ссылка				 - ЛюбаяСсылка	 - выгружаемые данные.
//  ИмяПланаОбмена		 - Строка		 - имя плана обмена, как объекта метаданных, по которому определяются узлы
//  ИмяРеквизитаФлага	 - Строка		 - имя реквизита плана обмена, по которому устанавливается фильтр на выборку узлов.
// 
// Возвращаемое значение:
//  Массив - Массив узлов плана обмена, для которых установлен признак «Выгружать при необходимости»егда».
//
...
//
// Параметры:
//  Ссылка					 - ЛюбаяСсылка	 - ссылка на объект ИБ, значения свойств которого требуется получить.
//  СвойстваОбъекта			 - Массив		 - свойства
//  СвойстваОбъектаСтрокой	 - Строка		 - свойства строкой
//  ОбъектМетаданныхИмя		 - Строка		 - тип данных.
// 
// Возвращаемое значение:
...
//
// Параметры:
//  ЗначенияСвойств		 - Структура - значения.
//  ТекстЗапроса		 - Строка	 - текст запроса.
//  ИмяПланаОбмена		 - Строка	 - имя плана обмена, как объекта метаданных, по которому определяются узлы
//  ИмяРеквизитаФлага	 - Строка	 - имя реквизита плана обмена, по которому устанавливается фильтр на выборку узлов.
//  Выгрузка			 - Булево	 - при выгрузке.
// 
// Возвращаемое значение:
//  Массив.
//
...
#Область СобытияПравилРегистрацииОбъектовСобытияПро
...
// Процедура предназначена для определения вида отправки выгружаемого элемента данных.
//  Вызывается из обработчиков планов обмена: ПриОтправкеДанныхГлавному(), ПриОтправкеДанныхПодчиненному().
//  Соответствует событиям ПриОтправкеДанныхГлавному() и ПриОтправкеДанныхПодчиненному().
//
// Параметры:
//  ЭлементДанных			 - Произвольный		 - данные.
//  ОтправкаЭлемента		 - ОтправкаЭлементаДанных	 - параметр события режим отправки.
...
//  СозданиеНачальногоОбраза - Булево					 - создается ли образ
//
Процедура ПриОтправкеДанныхОбменСФилиалами(ЭлементДанных, ОтправкаЭлемента, УзелИнформационнойБазы, Знач ИмяПланаОбмена, Знач СозданиеНачальногоОбраза) Экспорт
...
//
//  Параметры:
// Источник (обязательный) - объект информационной базы (СправочникОбъект, ДокументОбъект, ПланВидовХарактеристикОбъект
// и пр.) который является источником данных для заполнения.
//
// Приемник (обязательный) - объект информационной базы (СправочникОбъект, ДокументОбъект, ПланВидовХарактеристикОбъект
// и пр.) который будет заполнен данными источника.
//
...
//
// Параметры:
//  УзелПланаОбмена	 - ПланОбменаСсылка	 - узел
...
// Процедура ПроверитьУстранениеПроблемыДокументаОбработкаПроведения.
//
// Параметры:
...
// Процедура ПроверитьУстранениеПроблемыОбъектаПриЗаписи.
//
// Параметры:
...
#Область РаботаСКоллизиямиИзмененийДанныхПриОбмене
...
// 	УникальныйИдентификаторСтрокой - Строка - Создает пустую ссылку из УИДа, если у переданного объекта ссылка
// 	                                          отсутствует.
//
