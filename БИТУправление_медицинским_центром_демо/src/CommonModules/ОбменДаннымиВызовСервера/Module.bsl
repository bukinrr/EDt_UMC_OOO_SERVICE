...
//  ВыполнятьЗагрузку      - Булево - флаг необходимости выполнять загрузку данных. Значение по умолчанию - Истина
//  ВыполнятьВыгрузку      - Булево - флаг необходимости выполнять выгрузку данных. Значение по умолчанию - Истина.
...
// 								Значение по умолчанию - значение из РС.НастройкиТранспортаОбмена. 
//								Ресурс.ВидТранспортаСообщенийОбменаПоУмолчанию;
...
Процедура ПроверитьКэшМеханизмаРегистрацииОбъектов() Экспорт
	...
	Если ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных() Тогда
		...
		Если ПараметрыСеанса.ДатаОбновленияПовторноИспользуемыхЗначенийМРО = дата(1,1,1) Или
			ПараметрыСеанса.ДатаОбновленияПовторноИспользуемыхЗначенийМРО <> АктуальнаяДата Тогда
...
//  Знач ПолноеИмяФайлаСообщенияОбмена - Строка
//
...
// Параметры:
//  Знач УзелИнформационнойБазы - Неопределено
//  Знач ДействиеПриОбмене - Неопределено
//  Знач ДатаНачала - Дата
//  Знач СтрокаСообщенияОбОшибке - Строка
//
...
//  Знач ДатаНачалаОперации - Дата
//  Знач ПараметрыАутентификации - Неопределено - По умолчанию Неопределено
//
...
//  ДействиеПриОбменеСтрокой - Неопределено
//
// Возвращаемое значение:
//  Неопределено.
//
...
//
// Параметры:
//  Знач ИдентификаторОперации - Неопределено
//  Знач URLВебСервиса - Неопределено
//  Знач ИмяПользователя - Строка
...
//  Знач НовоеЗначениеПометкиУдаления - Неопределено
//
...
//  Знач ТекстЗапроса - Строка
//  Знач ИмяПланаОбмена - Строка
//  Знач ИмяРеквизитаФлага - Строка
//  Знач Выгрузка - Булево - По умолчанию Ложь
//
// Возвращаемое значение:
//  Неопределено.
//
