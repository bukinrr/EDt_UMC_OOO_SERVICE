...
//
// Параметры:
//  Адреса	 - Массив	 - из Структура - проверяемые адреса.
// 
// Возвращаемое значение:
//  Массив - из Структура - результаты анализа. Каждый элемент массива содержит структуры с полями:
//
...
//                          ФИАС; "ЗагруженныеДанные" - сначала будет попытка определить коды по загруженным данным
//                          адресного классификатора, а затем, если коды не были определены, то они будут получены
//                          через веб-сервис "1С".
