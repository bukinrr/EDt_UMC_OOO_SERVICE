...
// Получает строку, содержащую только цифры исходной
//
// Параметры:
//  ИсходнаяСтрока - Строка - строка для обработки.
//
// Возвращаемое значение:
//  Строка       - строка, которая содержит только цифры исходной;
//
Функция ПолучитьЦифрыСтроки(Знач ИсходнаяСтрока) Экспорт
