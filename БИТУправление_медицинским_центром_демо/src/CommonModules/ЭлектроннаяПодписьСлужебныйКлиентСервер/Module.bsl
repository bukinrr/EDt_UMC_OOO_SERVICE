...
Функция ПараметрыXMLDSig() Экспорт
	...
	ДанныеАлгоритмаПодписания.Вставить("URIАлгоритмаПодписи", "");
	
	ДанныеАлгоритмаПодписания.Вставить("ИмяАлгоритмаХеширования", "");
	ДанныеАлгоритмаПодписания.Вставить("OIDАлгоритмаХеширования", "");
	ДанныеАлгоритмаПодписания.Вставить("URIАлгоритмаХеширования", "");

	ДанныеАлгоритмаПодписания.Вставить("АлгоритмПодписи",     "");
	ДанныеАлгоритмаПодписания.Вставить("АлгоритмХеширования", "");
	
	//+бит
	ДанныеАлгоритмаПодписания.Вставить("ТипПодписания", "");
	ДанныеАлгоритмаПодписания.Вставить("ИмяТегаПодписи", "");
	
	МассивДопустимыхАлгоритмов = Новый Массив;
	МассивДопустимыхАлгоритмов.Добавить("1.2.643.2.2.3");
	МассивДопустимыхАлгоритмов.Добавить("1.2.643.7.1.1.3.2");
	МассивДопустимыхАлгоритмов.Добавить("1.2.643.7.1.1.3.3");
	
	ДанныеАлгоритмаПодписания.Вставить("ДопустимыеАлгоритмыПодписи", МассивДопустимыхАлгоритмов);
	//-бит
