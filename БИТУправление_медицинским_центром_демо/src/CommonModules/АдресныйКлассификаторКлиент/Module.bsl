...
//
// Параметры:
//  ОповещениеОЗакрытие - ОписаниеОповещения - оповещение, которое вызывается при закрытии формы загрузки адресного
//                                             классификатора.
...
//    * Окно                - ОкноКлиентскогоПриложения, ВариантОткрытияОкна - окно приложения, в котором будет открыта
//                            форма.
...
//  ПараметрыВыполнения - ПараметрыВыполненияКоманды, Структура - параметры открытия формы.
//  ОповещениеОЗакрытие - ОписаниеОповещения - оповещение, которое вызывается при закрытие формы загрузки адресного
//                                             классификатора.
//
...
// Процедура ОткрытьСведенияОбАдресномКлассификаторе.
//
// Параметры:
//  Параметры - Структура
//  ОписаниеОповещенияОЗакрытии - ОписаниеОповещения - оповещение
//
...
// Процедура АвторизоватьНаСайтеПоддержкиПользователей.
//
// Параметры:
//  ОповещениеОЗакрытии	 - ОписаниеОповещения	 - оповещение
//  ВладелецФормы		 - Произвольный.
//
...
// Процедура ВыбратьКаталогЗавершениеОтображенияДиалогаВыбораФайла.
//
// Параметры:
//  Каталог - Строка
...
// Процедура АнализДоступностиФайловКлассификатораВКаталогеЗавершение.
//
// Параметры:
//  ИндексРегиона - Строка
//  ДополнительныеПараметры - Структура
//
...
// Процедура АнализДоступностиФайловКлассификатораВКаталогеПослеПоискаФайлов.
//
// Параметры:
//  НайденныеФайлы - Массив
//  ДополнительныеПараметры - Структура
//
