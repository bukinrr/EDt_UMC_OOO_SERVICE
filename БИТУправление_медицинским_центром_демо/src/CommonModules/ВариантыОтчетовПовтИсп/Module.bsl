...
//			Или СтандартныеПодсистемыСервер.ЭтоОбъектРасширенияНеразделенногоПользователя(ОтчетМетаданные, УстановленныеРасширенияДоступны)
			Тогда
			Продолжить;
		КонецЕсли;
	...
	Для Каждого ЭлементСписка Из СписокРазделов Цикл
		...
		Если Не ЭтоНачальнаяСтраница
			И (Не ПравоДоступа("Просмотр", РазделМетаданные)
				...
				//Или СтандартныеПодсистемыСервер.ЭтоОбъектРасширенияНеразделенногоПользователя(РазделМетаданные, УстановленныеРасширенияДоступны))
				Тогда
...
Процедура ДобавитьПодсистемыТекущегоПользователя(СтрокаРодителя, МетаданныеРодителя, МассивПолныхИмен, ПолныеИменаСтрокДерева, УстановленныеРасширенияДоступны)
	...
	//		Или СтандартныеПодсистемыСервер.ЭтоОбъектРасширенияНеразделенногоПользователя(ПодсистемаМетаданные, УстановленныеРасширенияДоступны) 
			Тогда
			Продолжить; // Подсистема не доступна по ФО или по правам.
		КонецЕсли;
