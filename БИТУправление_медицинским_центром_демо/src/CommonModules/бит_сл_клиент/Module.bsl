...
Процедура ИнициализацияКлиентаЛицензирования() Экспорт
	...
	Иначе
		...
		ПодключитьОбработчикОжидания("бит_сл_Подключаемый_РасширениеВозможностейПлатформы", 6, Истина);
		ПодключитьОбработчикОжидания("бит_сл_Подключаемый_РасширениеВозможностейПлатформы", 600, Ложь);
