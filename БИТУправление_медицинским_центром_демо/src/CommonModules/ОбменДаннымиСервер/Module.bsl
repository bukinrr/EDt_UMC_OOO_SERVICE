...
// 
Процедура ВыполнитьОбменДаннымиПоРегламентномуЗаданию(КодСценарияОбмена = Неопределено) Экспорт
...
Процедура ОбновитьПовторноИспользуемыеЗначенияМРО() Экспорт
	...
	// БИТ+
	И Константы.ИспользоватьОбменДанными.Получить()
	// БИТ-
	;
