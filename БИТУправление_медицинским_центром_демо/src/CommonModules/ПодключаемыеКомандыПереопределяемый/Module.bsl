...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
    ...
    ДобавитьКомандуДляУведомленийОПриемкеМДЛП(Команды);
	ДобавитьКомандуДляУведомленийОбОприходованииМДЛП(Команды);
	
КонецПроцедуры

Процедура ДобавитьКомандуДляУведомленийОПриемкеМДЛП(Команды)
	                                                    
	КомандаОткрытьФормуЗаполненияНоменклатуры = Команды.Добавить();
	КомандаОткрытьФормуЗаполненияНоменклатуры.Представление = "Заполнить номенклатуру";
	КомандаОткрытьФормуЗаполненияНоменклатуры.Вид = "КоманднаяПанель";
	КомандаОткрытьФормуЗаполненияНоменклатуры.Менеджер = "Обработка.ЗаполнениеНоменклатурыМДЛП";
	КомандаОткрытьФормуЗаполненияНоменклатуры.ИмяФормы = "Форма.МДЛППодборНоменклатуры";
	КомандаОткрытьФормуЗаполненияНоменклатуры.ТипПараметра = Новый ОписаниеТипов("ДокументСсылка.УведомлениеОПриемкеМДЛП");
	КомандаОткрытьФормуЗаполненияНоменклатуры.ВидимостьВФормах = "ФормаДокумента";
	КомандаОткрытьФормуЗаполненияНоменклатуры.Назначение = "ДляОбъекта";
	
КонецПроцедуры

Процедура ДобавитьКомандуДляУведомленийОбОприходованииМДЛП(Команды)
	...
	КомандаОткрытьФормуЗаполненияНоменклатуры.Менеджер = "Обработка.ЗаполнениеНоменклатурыМДЛП";
	КомандаОткрытьФормуЗаполненияНоменклатуры.ИмяФормы = "Форма.МДЛППодборНоменклатуры";
	КомандаОткрытьФормуЗаполненияНоменклатуры.ТипПараметра = Новый ОписаниеТипов("ДокументСсылка.УведомлениеОбОприходованииМДЛП");
	КомандаОткрытьФормуЗаполненияНоменклатуры.ВидимостьВФормах = "ФормаДокумента";
	КомандаОткрытьФормуЗаполненияНоменклатуры.Назначение = "ДляОбъекта";
