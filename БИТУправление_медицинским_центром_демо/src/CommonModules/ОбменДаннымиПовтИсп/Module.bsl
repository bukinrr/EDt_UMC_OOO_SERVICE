...
//
// Параметры:
//  ПараметрыВнешнегоСоединения - Неопределено
...
// Функция ОбработкаОбменаДляЗагрузкиДанных.
//
// Параметры:
//  Отказ - Булево
...
//  Неопределено.
//
Функция ОбработкаОбменаДляЗагрузкиДанных(Отказ, УзелИнформационнойБазы, ИмяФайлаСообщенияОбмена) Экспорт
	Отказ = Истина;
...
//  Знач ВерсияКорреспондента - Строка - По умолчанию ""
//
// Возвращаемое значение:
//  Неопределено.
//
...
//  Отказ - Булево
//  Знач УзелИнформационнойБазы - Неопределено
//  Знач ИмяФайлаСообщенияОбмена - Строка
//
// Возвращаемое значение:
//  Неопределено.
//
...
//  внешнее соединение СтрокаСообщенияОбОшибке (необязательный) - Строка - если в процессе установки внешнего
//  соединения возникает ошибка, то подробное описание ошибки помещается в этот параметр.
//
// Возвращаемое значение:
...
//
// Параметры:
//  БезопасныйРежим - Неопределено - По умолчанию Неопределено
//
// Возвращаемое значение:
...
// Параметры:
//  ИмяПланаОбмена   - Строка - имя плана обмена, как оно задано в конфигураторе.
//  ПолноеИмяОбъекта - Строка - полное имя объекта метаданных, для которого требуется получить признак использования
//  правил регистрации.
// 
// Возвращаемое значение:
//  Неопределено.
