...
Процедура ПриЗагрузкеВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	Попытка
		ПрейскурантУслуг = УправлениеНастройками.ПолучитьПрейскурантФилиала();
		ПрейскурантМатериалов = УправлениеНастройками.ПолучитьПараметрУчетнойПолитики("ПрейскурантРасчетаСтоимостиМатериалов");
		
		Если ЗначениеЗаполнено(ПрейскурантУслуг) Тогда
			ПараметрДанных = НовыеНастройкиКД.ПараметрыДанных.Элементы.Найти("ПрейскурантУслуг");
			Если ПараметрДанных <> Неопределено И Не ЗначениеЗаполнено(ПараметрДанных.Значение) Тогда
				ПараметрДанных.Значение = ПрейскурантУслуг;
			КонецЕсли;
			
			ПараметрДанных = КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ПрейскурантУслуг");
			Если ПараметрДанных <> Неопределено И Не ЗначениеЗаполнено(ПараметрДанных.Значение) Тогда
				ПараметрДанных.Значение = ПрейскурантУслуг;
			КонецЕсли;
		КонецЕсли;
		
		Если ЗначениеЗаполнено(ПрейскурантМатериалов) Тогда
			ПараметрДанных = НовыеНастройкиКД.ПараметрыДанных.Элементы.Найти("Прейскурант");
			Если ПараметрДанных <> Неопределено И Не ЗначениеЗаполнено(ПараметрДанных.Значение) Тогда
				ПараметрДанных.Значение = ПрейскурантМатериалов;
			КонецЕсли;
