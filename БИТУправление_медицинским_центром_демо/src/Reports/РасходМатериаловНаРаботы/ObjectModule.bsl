...
Процедура ПриЗагрузкеВариантаНаСервере(Форма, НовыеНастройкиКД) Экспорт
	...
	Попытка
		...
		ПараметрДанных = НовыеНастройкиКД.ПараметрыДанных.Элементы.Найти("ПрейскурантССМатериалов");
		Если ПараметрДанных <> Неопределено И Не ЗначениеЗаполнено(ПараметрДанных.Значение) Тогда
			ПараметрДанных.Значение = Прейскурант;
		КонецЕсли;
		
		ПараметрДанных = КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ПрейскурантССМатериалов");
		Если ПараметрДанных <> Неопределено И Не ЗначениеЗаполнено(ПараметрДанных.Значение) Тогда
			ПараметрДанных.Значение = Прейскурант;
		КонецЕсли;
	Исключение
