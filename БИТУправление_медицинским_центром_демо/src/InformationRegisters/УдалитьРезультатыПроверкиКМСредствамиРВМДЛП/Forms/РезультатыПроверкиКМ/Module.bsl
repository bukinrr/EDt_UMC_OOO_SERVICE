...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Для Каждого КлючИЗначение Из Параметры.РезультатыПроверки Цикл
		...
		Представление = КонтрольКодовМаркировкиМДЛПКлиентСервер.ПредставлениеРезультатаПроверкиКМСредствамиРВ(РезультатЭлементаПроверки);
...
Функция СвойстваРезультатаПроверки()
	...
	Возврат РегистрыСведений.УдалитьРезультатыПроверкиКМСредствамиРВМДЛП.СвойстваРезультатаПроверкиКМ();
