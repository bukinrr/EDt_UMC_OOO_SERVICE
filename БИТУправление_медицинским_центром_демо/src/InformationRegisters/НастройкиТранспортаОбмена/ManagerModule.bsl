...
#Область ФункцииПолученияЗначенийНастроекДляУзлаПланаОбмена
...
//  ВидТранспортаОбмена	 - ПеречислениеСсылка.ВидыТранспортаСообщенийОбмена	 - способ обмена файлами.
// 
...
// Функция НастройкиТранспортаWS.
//
// Параметры:
//  Узел					 - ПланОбменаСсылка	 - узел плана обмена.
//  ПараметрыАутентификации	 - Структура		 - параметры авторизации при обмене.
// 
// Возвращаемое значение:
//  Структура.
//
...
// Функция ВидТранспортаСообщенийОбменаПоУмолчанию.
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка	 - узел плана обмена.
//
// Возвращаемое значение:
//  ПеречислениеСсылка.ВидыТранспортаСообщенийОбмена.
//
...
// Представления настроек транспорта обмена.
//
// Параметры:
//  ВидТранспорта	 - ПеречислениеСсылка.ВидыТранспортаСообщенийОбмена	 - вид транспорта.
// 
// Возвращаемое значение:
//  Строка.
//
...
// Заданы ли настройки транспорта для узла.
//
// Параметры:
//  Узел - ПланОбменаСсылка	 - узел плана обмена.
// 
...
// Количество элементов в транзакциях загрузки.
//
// Параметры:
//  Узел - ПланОбменаСсылка	- узел плана обмена.
//
...
// Количество элементов в транзакциях выгрузки.
//
// Параметры:
//  Узел - ПланОбменаСсылка	- узел плана обмена.
//
...
// Перечень настроенных  видов транспорта узла.
//
// Параметры:
//  УзелИнформационнойБазы - ПланОбменаСсылка	- узел плана обмена.
//
