...
// 	ДвоичныеДанные - ДвоичныеДанные - данные, в которые сохраняется XML-файл (в том числе и распакованный из
// 	                                  ZIP-архива).
...
// Процедура ЗагрузитьИнформациюОПравилах.
//
// Параметры:
//  Отказ - Булево
//  АдресВременногоХранилища - Неопределено
//  СтрокаИнформацииОПравилах - Строка
//
