...
#Область ВыводСпискаИзменившихсяРеквизитов
...
#Область ФункцииДляПолученияОтчетаПоИзменениям
...
Процедура ВывестиИзмененияРеквизитов(ТЧОтчета,
	...
	Для Каждого ЭлементМодРеквизит Из ТаблицаИзмененийРеквизитов Цикл
		Если ЭлементМодРеквизит.Версионирование_Модификация = Истина Тогда
			...
			// Выводим наименование, предварительно заменяя его на другое, если оно является предопределенным.
...
#Область ФормируемСписокТабличныхЧастейКоторыеИзменились

#КонецОбласти

#Область Списоктабличныхчастей0Создатьтаблицусравнения
...
#Область ФормируемСписокРеквизитовКоторыеИзменились

#КонецОбласти

#Область Списокреквизитов0Создатьтаблицусравнения
...
Функция РазборПредставленияОбъектаXML(ДвоичныеДанные, Ссылка)
	...
	// Второй этап: из списка реквизитов исключаем табличные части.
...
// Используется для вывода текста в область табличного документа с условным оформлением.
