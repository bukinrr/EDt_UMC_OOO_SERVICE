...
Перем ДоступностьОбъектовПоОпциям Экспорт; // ДоступностьОбъектовПоОпциям
...
//     АдресХранилища - Произвольный - Адрес временного хранилища для сохранения результата при запуске в фоновом
//                                     задании.
//
// Возвращаемое значение: 
