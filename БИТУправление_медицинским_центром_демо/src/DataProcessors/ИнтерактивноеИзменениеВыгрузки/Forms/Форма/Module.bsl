...
&НаКлиенте
// Процедура НастройкиОтборовВыборВариантаЗавершение.
//
// Параметры:
//  Знач ВыбранныйЭлемент - Неопределено
...
&НаКлиенте
// Процедура НастройкиОтборовЗавершение.
//
// Параметры:
//  Знач РезультатВопроса - Неопределено
//  Знач ДополнительныеПараметры - Неопределено
//
...
&НаКлиенте
// Процедура ДополнительнаяРегистрацияОбработкаВыбораЗавершение.
//
// Параметры:
//  Знач РезультатВопроса - Неопределено
//  Знач ДополнительныеПараметры - Неопределено
...
&НаКлиенте
// Процедура ДополнительнаяРегистрацияПередУдалениемЗавершение.
//
// Параметры:
//  Знач РезультатВопроса - Неопределено
//  Знач ДополнительныеПараметры - Неопределено
