...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтандартныеПодсистемыСервер.УстановитьОтображениеЗаголовковГрупп(ЭтаФорма, "ГруппаДанные, ГруппаСобытие, ГруппаСоединение, ГруппаТранзакция");
...
Процедура РазделениеДанныхСеансаОткрытие(Элемент, СтандартнаяОбработка)
	...
	ОткрытьЗначение(РазделениеДанныхСеанса);
