...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Или ТолстыйКлиентУправляемоеПриложение Тогда // +бит добавлено ТолстыйКлиентУправляемоеПриложение.
...
// БИТ.Начало
Процедура УстановитьКлючДанных(КлючДанных) Экспорт
	
	ПарольДляРаспаковкиФайлаОбмена = КлючДанных;
