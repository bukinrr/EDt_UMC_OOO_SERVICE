...
#Область РазделОписанияВспомогательныхПеременных
...
#Область ПроцедурыИФункцииЗагрузкиПравилРегистрацииОбъектов
...
#Область ПроцедурыИФункцииКомпиляцииПравилРегистрацииОбъектов

// Для ПРО по свойствам Плана обмена.
...
Функция ПолучитьТекстУсловияДляГруппыСвойств(СвойстваГруппы, БулевоЗначениеГруппы, Знач Смещение, СвойстваОбъекта)
	...
	Для счетчик = 0 По Смещение Цикл
