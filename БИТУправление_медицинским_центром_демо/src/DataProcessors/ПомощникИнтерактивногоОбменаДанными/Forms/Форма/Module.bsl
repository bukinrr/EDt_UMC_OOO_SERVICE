...
//         для поиска узла плана обмена с кодом, заданными в параметре КодУзлаИнформационнойБазы.
//
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	// Пока не перейдем на новую версию БСП.
...
#Область СтраницаСтраницаначала
...
Процедура ВидТранспортаСообщенийОбменаПриИзмененииНаСервере()
	...
	Иначе
		...
		Элементы.ИнформационнаяНадписьНастройкиРасписания.Видимость = Не УзелИспользуетсяВСценарииОбмена И ИСТИНА;// Пользователи.РолиДоступны("НастройкаСинхронизацииДанных");
		
		ОткрытьПомощникСозданияСценарияОбменаДанными = ИСТИНА;        
