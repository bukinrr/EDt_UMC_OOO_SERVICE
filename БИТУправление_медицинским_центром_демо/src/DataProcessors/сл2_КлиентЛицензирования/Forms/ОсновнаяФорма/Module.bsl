...
Процедура ОбновитьСостояниеКлиентаЛицензирования()
	...
	БИТ_Защита_Конфигурации.ОбновитьСтатусЛицензии(СостояниеЛицензирования);
	...
	Для Каждого СостояниеПродукта Из СостояниеЛицензирования.ЛицензируемыеПродукты Цикл
		...
		Если СостояниеПродукта.ЛицензияПолучена Тогда
			...
			Если МассивФорматированныхНаименованийПолученныхЛицензий.Найти(ФС) = Неопределено Тогда
		...
		Иначе
			...
			Если МассивФорматированныхНаименованийНеПолученныхЛицензий.Найти(ФС) = Неопределено Тогда
	...
	Если Элементы.ГруппаПолученныеЛицензии.Видимость Тогда
		Элементы.ГруппаНеПолученныеЛицензии.Видимость      = Ложь;
	Иначе
...
Процедура ПриОткрытии(Отказ)
	...
	// Контроль уникальности формы
	Если ЭтаФорма.КлючУникальности <> "24a77819-277f-4773-a32c-bc5b7116770d" Тогда
		// Форма открыта без указания уникальности
		Отказ = Истина;
